#ifndef LIB_AMG88XX_H
#define LIB_AMG88XX_H
...
/**************************************************************************/
/*!
	Arduino中int为2字节，树莓派中int为4字节 故需要对此处进行调整
*/
/**************************************************************************/
typedef unsigned char uint8_t;
typedef unsigned char byte;
typedef short int16_t; //16bit有符号类型
typedef unsigned short uint16_t;//16bit有符号类型

//宏实现constrain函数 保证返回值在最低和最高之间
...
#define AMG88xx_ADDRESS (0x69) //I2C设备默认地址
